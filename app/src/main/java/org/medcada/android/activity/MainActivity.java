...
import org.medcada.android.adapter.HomePagerAdapter;
...
//startActivity(new Intent(this,PinCodeActivity.class));
        ...
        final PrimaryDrawerItem item_login = new PrimaryDrawerItem().withName("Login / Register").withIcon(VectorDrawableCompat.create(getResources(), R.drawable.ic_vpn_key_black_24dp, null)).withSelectable(false).withTypeface(Typeface.DEFAULT_BOLD);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem.equals(itemSettings)) {
                            ...
                            // About
                            startAboutActivity();
                        } else if (drawerItem.equals(itememergency)) {
                            // About
...
//                        }
    ...
    int CODE_DRAW_OVER_OTHER_APP_PERMISSION = 1234;
    ...
    private void startMedicationActivity() {
    ...
    public void openSupportDialog() {
        ...
        builder.setItems(getResources().getStringArray(R.array.menu_support_options), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (which == 0) {
                    // Email
                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:support@assistbud.com"));
