...
public class HelloPresenter {
    ...
    public void onNextClicked(String age, String gender, String language, String country, int type, String unit,String contactNumber) {
        if (validateAge(age)) {
            saveToDatabase(id, name, language, country, Integer.parseInt(age), gender, type, unit,contactNumber);
    ...
    private void saveToDatabase(final int id, final String name, final String language,
                                ...
                                final int diabetesType, final String unitMeasurement,String contactNumber) {
        dB.addUser(new User(id, name, language, country, age, gender, diabetesType, unitMeasurement,
                "percentage", "kilograms", "ADA", 70, 180,contactNumber)); // We use ADA range by default
    }
}
