...
import org.medcada.android.receivers.GlucosioBroadcastReceiver;
...
public class GlucosioAlarmManager {
    ...
    public void setAlarms() {
        ...
        for (int i = 0; i < reminders.size(); i++) {
            ...
            intent.putExtra("reminder_sms", reminder.getSms());
            intent.putExtra("isReminder", reminder.isReminder());
